...
function MessageDisplay() {
  ...
  return (
    <div className="absolute flex flex-col justify-center items-center w-[90%] h-[90%] z-[100] mix-blend-difference">
      <div 
      ...
      >
        ...
        <div className="text-[15px] w-1/2 min-w-[40%] text-center text-gray-400 m-[1%]">
  ...
  useEffect(() => {
    const handleResize = () => {
      if (charactersRef.current) {
        ...
        // Note: contentchanged event might not be natively listened to by the previous effect
        // but we'll leave it as is or trigger a re-render if needed.
        // Actually, the effect will only run on mount.
      }
    };
...
function CircleAnimation() {
  ...
  useEffect(() => {
    ...
    const handleResize = () => {
      ...
      const context = canvas.getContext('2d');
      if (context) {
        context.resetTransform(); // Use resetTransform instead of context.reset() which is newer
      }
